...
const GlobalResult = () => {
    ...
    const [result, setResult] = useState([
        ...
        { type: 'tag', id: 2, title: 'Next.js'},
        { type: 'user', id: 3, title: 'Bogdan'}
    ]);
    ...
    return (
        <div className='absolute top-full z-10 mt-3 w-full bg-light-800 py-5 shadow-sm dark:bg-dark-400 rounded-xl'>
            ...
            <div className='my-6 h-[1px] bg-light-700/50 dark:bg-dark-500/50'></div>
                            ...
                            result.map((item: any, index: number) => (
                                ...
                                >
                                    ...
                                    <div className='flex flex-col'>
                                        ...
                                        <p className='text-light400_light500 small-medium capitalize mt-1 font-bold'>{item.type}</p>
                                    </div>
                                </Link>
                            ))
                        ) : (
